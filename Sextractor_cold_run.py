def run_cold_sex(image, output_catalog, mag_zero, seeing_fwhm, sex_config='cold_run.sex', param_file='default.param',
            _print=True):
    """
    ...
    s_img = Popen([se_executable, image + ',' + image, '-c', sex_config, '-PARAMETERS_NAME', param_file,
                   '-CATALOG_NAME', output_catalog + '/' + output_catalog_name, '-MAG_ZEROPOINT', mag_zero, '-SEEING_FWHM', seeing_fwhm],
